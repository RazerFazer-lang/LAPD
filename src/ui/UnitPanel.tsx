...
const statusText: Record<UnitStatus,string> = {
  AVAILABLE:'VERFÜGBAR', BUSY:'BELEGT', EN_ROUTE:'AUF ANFAHRT', ON_SCENE:'VOR ORT',
  TRANSPORTING:'TRANSPORT', RETURNING:'RÜCKKEHR', OUT_OF_SERVICE:'AUßER DIENST', MAINTENANCE:'WARTUNG',
};
