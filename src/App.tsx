...
// Multiplayer production endpoint. The game page itself may be served from AMP on the same host.
const serverUrl=import.meta.env.VITE_SERVER_URL??'ws://gaminglive.mooo.com:7778';
